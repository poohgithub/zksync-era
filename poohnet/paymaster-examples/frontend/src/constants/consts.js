...
export const AAFACTORY_CONTRACT_ABI =
    require("../../../contracts/artifacts-zk/contracts/aa/AAFactory.sol/AAFactory.json").abi;
export const AA_CONTRACT_ABI =
    require("../../../contracts/artifacts-zk/contracts/aa/Account.sol/Account.json").abi;